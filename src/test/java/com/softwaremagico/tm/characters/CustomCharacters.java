...
public class CustomCharacters {
	...
	public void geek() throws MalformedURLException, DocumentException, IOException, InvalidXmlElementException,
		...
		characterPlayer.setSkillRank(
				AvailableSkillsFactory.getInstance().getElement("lore", "computingLore", characterPlayer.getLanguage(),
						characterPlayer.getModuleName()), 5);
		characterPlayer.setSkillRank(
				AvailableSkillsFactory.getInstance().getElement("electronics", characterPlayer.getLanguage(),
						characterPlayer.getModuleName()), 4);
		characterPlayer.setSkillRank(
	...
	public void bill() throws MalformedURLException, DocumentException, IOException, InvalidXmlElementException,
		...
		characterPlayer.setSkillRank(
				AvailableSkillsFactory.getInstance().getElement("aircraft", characterPlayer.getLanguage(),
						characterPlayer.getModuleName()), 7);
		characterPlayer.setSkillRank(
				AvailableSkillsFactory.getInstance().getElement("leadership", characterPlayer.getLanguage(),
						characterPlayer.getModuleName()), 3);
		characterPlayer.setSkillRank(
				AvailableSkillsFactory.getInstance().getElement("lore", "weaponsLore", characterPlayer.getLanguage(),
						characterPlayer.getModuleName()), 6);
		characterPlayer.setSkillRank(
				AvailableSkillsFactory.getInstance().getElement("warfare", characterPlayer.getLanguage(),
						characterPlayer.getModuleName()), 5);
		characterPlayer.setSkillRank(
				AvailableSkillsFactory.getInstance().getElement("mechanics", characterPlayer.getLanguage(),
						characterPlayer.getModuleName()), 2);
		characterPlayer.setSkillRank(
				AvailableSkillsFactory.getInstance().getElement("slugGuns", characterPlayer.getLanguage(),
						characterPlayer.getModuleName()), 5);
		characterPlayer.setSkillRank(
				AvailableSkillsFactory.getInstance().getElement("artillery", characterPlayer.getLanguage(),
						characterPlayer.getModuleName()), 3);
		characterPlayer.setSkillRank(
				AvailableSkillsFactory.getInstance().getElement("gunnery", characterPlayer.getLanguage(),
						characterPlayer.getModuleName()), 3);
		characterPlayer.setSkillRank(
				AvailableSkillsFactory.getInstance().getElement("melee", characterPlayer.getLanguage(),
						characterPlayer.getModuleName()), 5);
		characterPlayer.setSkillRank(
	...
	public void sportGirl() throws MalformedURLException, DocumentException, IOException, InvalidXmlElementException,
		...
		characterPlayer.setSkillRank(
				AvailableSkillsFactory.getInstance().getElement("fight", characterPlayer.getLanguage(),
						characterPlayer.getModuleName()), 8);

		characterPlayer.setSkillRank(
				AvailableSkillsFactory.getInstance().getElement("athletics", characterPlayer.getLanguage(),
						characterPlayer.getModuleName()), 5);
		characterPlayer.setSkillRank(
				AvailableSkillsFactory.getInstance().getElement("landcarft", characterPlayer.getLanguage(),
						characterPlayer.getModuleName()), 4);
		...
		characterPlayer.getInfo().setCharacterDescription(
				characterPlayer.getCompleteNameRepresentation()
						+ " es una boxeadora profesional de la vieja Rusia, ganadora de una medalla de plata "
	...
	public void nerd() throws MalformedURLException, DocumentException, IOException, InvalidXmlElementException,
		...
		characterPlayer.setSkillRank(
				AvailableSkillsFactory.getInstance().getElement("lore", "undead", characterPlayer.getLanguage(),
						characterPlayer.getModuleName()), 4);
		characterPlayer.setSkillRank(
				AvailableSkillsFactory.getInstance().getElement("lore", "demons", characterPlayer.getLanguage(),
						characterPlayer.getModuleName()), 4);
		characterPlayer.setSkillRank(
				AvailableSkillsFactory.getInstance().getElement("lore", "fairies", characterPlayer.getLanguage(),
						characterPlayer.getModuleName()), 4);
		characterPlayer.setSkillRank(
				AvailableSkillsFactory.getInstance().getElement("computing", characterPlayer.getLanguage(),
						characterPlayer.getModuleName()), 4);
